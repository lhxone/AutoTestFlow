...
INSERT INTO `system_setting` (`category`, `key`, `value`, `encrypted`, `description`) VALUES
  ('knowledge_base', 'knowledge_base.enabled', 'false', 0, '是否启用 RAG 知识库'),
  ('knowledge_base', 'knowledge_base.vector_store.type', 'milvus', 0, '向量存储类型'),
  ('knowledge_base', 'knowledge_base.vector_store.host', 'localhost', 0, 'Milvus 地址'),
  ('knowledge_base', 'knowledge_base.vector_store.port', '19530', 0, 'Milvus 端口'),
  ('knowledge_base', 'knowledge_base.vector_store.collection', 'autotestflow_knowledge', 0, 'Milvus Collection'),
  ('knowledge_base', 'knowledge_base.embedding.model', 'text-embedding-3-small', 0, 'Embedding 模型名'),
  ('knowledge_base', 'knowledge_base.embedding.dimension', '1536', 0, 'Embedding 向量维度'),
  ('knowledge_base', 'knowledge_base.embedding.batch_size', '16', 0, 'Embedding 批大小'),
  ('knowledge_base', 'knowledge_base.chunk_size', '500', 0, '默认 chunk 大小'),
  ('knowledge_base', 'knowledge_base.chunk_overlap', '50', 0, '默认 chunk 重叠'),
  ('knowledge_base', 'knowledge_base.top_k', '5', 0, '默认检索数量'),
  ('knowledge_base', 'knowledge_base.similarity_threshold', '0.75', 0, '相似度阈值')
